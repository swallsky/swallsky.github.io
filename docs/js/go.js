...
`;function Py(){return ce.default.createElement(Ey,null,ce.default.createElement("ul",null,ce.default.createElement("li",null,ce.default.createElement("a",{href:"./"},"\u9996\u9875")),ce.default.createElement("li",null,ce.default.createElement("a",{href:"./markdown.html"},"Markdown")),ce.default.createElement("li",null,ce.default.createElement("a",{href:"./go.html"},"Go\u8BED\u8A00"))))}var uf=Py;var Ht=ye(ge());function Cy(n){let[e,t]=(0,Ht.useState)(!1);return(0,Ht.useEffect)(()=>{t(!0)},[]),Ht.default.createElement("div",{style:{display:e?"":"none"}},n.children)}var pf=Cy;var qy=Ks.div`
  display: flex;
