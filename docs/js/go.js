...
`;function Ny(n){return ba.default.createElement(cf,null,ba.default.createElement(uf,null),ba.default.createElement(qy,null,n.children))}var pf=Ny;function Ty(n){return Ht.default.createElement(pf,null,Ht.default.createElement("div",{className:"menu"},Ht.default.createElement("div",{dangerouslySetInnerHTML:{__html:n.serData.markdown.menus}})),Ht.default.createElement("div",{className:"cnt"},Ht.default.createElement("div",{dangerouslySetInnerHTML:{__html:n.serData.markdown.content}})))}var df=Ty;var Oy={title:"go\u57FA\u7840",mdfile:"go-base.md",serData:{markdown:{content:`<h3 id="" tabindex="-1">\u7B80\u4ECB <a class="header-anchor" href="#">\xA7</a></h3>
<blockquote>
